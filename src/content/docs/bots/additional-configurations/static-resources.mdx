...
<Tabs syncKey="dashNewNav">
	<TabItem label="Old dashboard">
		<Steps>
			...
			domain. 2. Go to **Security** > **Bots**. 3. Select **Configure Super Bot
			Fight Mode**. 4. For **Static resource protection**, select **On**.
		</Steps>
	</TabItem>
	<TabItem label="New dashboard" icon="rocket">
		<Steps>
			...
			traffic**. 4. Go to **Super Bot Fight Mode**. 5. Under **Configurations**,
			select the edit icon for **Static resource protection** and turn it on.
		</Steps>
	</TabItem>
</Tabs>
